...
class FlightSetupScreen : FABaseScreen(Component.translatable("menu.flightassistant")) {
    override fun init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Component.translatable("menu.flightassistant.flight_plan")) {
            this.client!!.setScreen(FlightPlanScreen())
        }.position(this.centerX - 175, this.centerY - 10).width(100).build())
        this.addDrawableChild(ButtonWidget.builder(Component.translatable("menu.flightassistant.system")) {
            this.client!!.setScreen(SystemStatusScreen())
        }.position(this.centerX + 75, this.centerY - 10).width(100).build())
        this.addDrawableChild(ButtonWidget.builder(Component.translatable("menu.flightassistant.autoflight")) {
